...
public class WatchingListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBarLayout.setTitle("Watching List");

        auth = FirebaseAuth.getInstance();
        rootRef = FirebaseDatabase.getInstance().getReference();
        FirebaseUser user = auth.getCurrentUser();
        userID = user.getUid();
        listsRef = rootRef.child("lists").child(userID).child("watching list");
        ...
        movieAdapter = new MovieListAdapter(movieInformationArrayList,WatchingListActivity.this,  "watching list");

        linearLayoutManager = new LinearLayoutManager(WatchingListActivity.this, RecyclerView.VERTICAL, false);
