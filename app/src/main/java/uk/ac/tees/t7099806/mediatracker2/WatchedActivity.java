...
public class WatchedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBarLayout.setTitle("Watched List");
        ...
        userID = user.getUid();
        listsRef = rootRef.child("lists").child(userID).child("watched list");
        ...
        movieListAdapter = new MovieListAdapter(movieInformationArrayList,WatchedActivity.this , "");

        linearLayoutManager = new LinearLayoutManager(WatchedActivity.this, RecyclerView.VERTICAL, false);
